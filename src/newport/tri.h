...
typedef void (*span_setup_func_t)(void *arg, uint32_t color);
...
extern	void benchmark_triangle(span_setup_func_t setup_fn, span_func_t fn,
	     void *arg, int num_triangles);
